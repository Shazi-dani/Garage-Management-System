...
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD')  # Use an app-specific password if two-factor authentication is enabled
...
# Configure REST Framework to use Session Authentication
REST_FRAMEWORK = {
...
# Optional: Customize message tags to work well with SweetAlert
